...
function Section2() {
  return (
    <section className="bg-[#FFEBE0] w-full px-4 pt-16">
      <div className="md:flex lg:flex-row md:justify-between md:items-center md:mx-8 lg:mx-48">
        ...
        <div className="">
          <Image
            ...
            height={200}
            src="/image1.svg"
            className="w-[380px] md:w-[400px] lg:w-[600px] h-auto -mt-28 md:mt-2"
            data-aos="zoom-in"
            data-aos-duration="1000"
            data-aos-delay="400"
          />
