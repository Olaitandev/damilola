  ...
  return (
    <>
      ...
      >
        ...
        {/* ↓ THE KEY FIX — same pattern as ContactDialog */}
        <DialogContent
        ...
        >
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <DialogHeader>
              ...
              <DialogDescription className="mt-1 text-sm text-center text-gray-600">
                Speaking engagements are limited and reviewed carefully. Use the
                form below to request Dami for your conference, summit, or
                corporate event. My team will respond within 48 hours to discuss
                availability, format, and fees.
                ...
                {[0, 1].map((i) => (
                  <div
                    ...
                    className={`h-2 w-16 rounded-full transition-colors ${
                      currentTab === i ? "bg-[#EDF296]" : "bg-gray-300"
                    }`}
                  />
                ))}
              </div>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div>
                  <input
                    ...
                    value={formData.name}
                    onChange={handleChange}
                    className={`w-full p-2 border rounded-full focus:ring-2 focus:ring-blue-500 ${errors.name ? "border-red-500" : "border-gray-300"}`}
                  />
                  {errors.name && (
                    <p className="mt-1 pl-3 text-xs text-red-500">
                      {errors.name}
                    </p>
                  )}
                </div>
                ...
                <div>
                  <input
                    ...
                    suppressHydrationWarning
                    onChange={handleChange}
                    className={`w-full p-2 border rounded-full focus:ring-2 focus:ring-blue-500 ${errors.email ? "border-red-500" : "border-gray-300"}`}
                  />
                  {errors.email && (
                    <p className="mt-1 pl-3 text-xs text-red-500">
                      {errors.email}
                ...
                <div>
                  <input
                    ...
                    value={formData.phone}
                    onChange={handleChange}
                    className={`w-full p-2 border rounded-full focus:ring-2 focus:ring-blue-500 ${errors.phone ? "border-red-500" : "border-gray-300"}`}
                  />
                  {errors.phone && (
                    <p className="mt-1 pl-3 text-xs text-red-500">
                      {errors.phone}
                ...
                <div>
                  <input
                    ...
                    value={formData.organization}
                    onChange={handleChange}
                    className={`w-full p-2 border rounded-full focus:ring-2 focus:ring-blue-500 ${errors.organization ? "border-red-500" : "border-gray-300"}`}
                  />
                  {errors.organization && (
                    <p className="mt-1 pl-3 text-xs text-red-500">
                      {errors.organization}
                ...
                <h2 className="text-lg font-semibold mt-1">Event Details</h2>
                  ...
                  {[
                    ...
                    >
                      <input
                        ...
                        name="engagementType"
                        value={type}
                        checked={formData.engagementType === type}
                        onChange={handleChange}
                      />
                      {type}
                    </label>
            ...
            {currentTab === 1 && (
              <div className="flex flex-col gap-3">
                <h2 className="text-lg font-semibold">Audience & Topics</h2>
                ...
                <p className="font-medium">Topics You're Interested In</p>
                ...
                />
                <p className="text-sm text-gray-500">
                  Please share the budget allocated for this engagement. This
                  helps us recommend the best format and package.
                </p>
                ...
                <textarea
                  ...
                  value={formData.message}
                  onChange={handleChange}
                  className="w-full p-2 border border-gray-300 rounded-2xl h-28 resize-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
            )}
              ...
              <div className="flex gap-3 w-full">
                ...
                {currentTab < 1 ? (
                  <button
                    type="button"
                    onClick={handleNext}
                    className="bg-[#EDF296] text-black hover:bg-[#EDF296]/90 flex-1 rounded px-4 py-2 text-sm font-medium"
                  >
                    Next
                  </button>
                ) : (
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/20">
          <div className="bg-white rounded-2xl shadow-lg p-6 w-[90%] max-w-sm text-center">
            ...
            <p className="mt-4 text-sm text-gray-600">
              I'll review your event details and get back to you within 48
              hours. Feel free to connect with me on [LinkedIn], [Instagram], or
              [X] for insights on remote work, HR strategy, and speaking
              engagements.
            </p>
            <p className="mt-4 text-sm font-semibold">
              If this is time-sensitive, you can also reach me directly at
