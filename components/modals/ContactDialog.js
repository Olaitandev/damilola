          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div>
                <textarea
                  ...
                  value={formData.message}
                  onChange={handleChange}
                  className="w-full h-28 p-2 border border-gray-300 resize-none rounded-xl focus:ring-2 focus:ring-blue-500"
                />
                {errors.message && (
            ...
            <DialogFooter>
              <Button
                type="submit"
                disabled={isSubmitting}
                className="w-full bg-[#EDF296] text-black hover:bg-[#EDF296]/90"
              >
                {isSubmitting ? "Submitting..." : "Submit Partnership Request"}
              </Button>
            </DialogFooter>
