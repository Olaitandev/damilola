...
// ── Client-side spam detection (mirrors edge function) ────────────────────────
...
function PartnershipForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    // 2. Spam checks — silent drop
    if (
      isRandomString(formData.name) ||
      isRandomString(formData.brand) ||
      isRandomString(formData.message)
    )
      return;
