...
function PartnershipHero({
  ...
  return (
    <div>
      <section className="bg-[#27221F] w-full px-5 pt-16 pb-16 lg:pb-24">
        <div className="flex flex-col items-center justify-center pt-10 mx-auto lg:max-w-7xl lg:pt-20">
          <h2
